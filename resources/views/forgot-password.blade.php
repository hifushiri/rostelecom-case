...
<head>
    ...
    <title>Восстановление пароля - Ростелеком Управление проектами</title>
...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="forgot-password-container">
        ...
        <h2 class="text-2xl font-semibold text-center mb-6 text-[var(--rtk-gray)]">Восстановление пароля</h2>
        ...
        <div class="hidden bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded mb-4">
            <ul class="list-disc list-inside">
                <li>Укажите корректный email</li>
            </ul>
        </div>
